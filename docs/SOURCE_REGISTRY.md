...
| DSE market data (prices, indices, volumes) | https://www.dse.co.tz/ | End-of-day prices, history, index levels | Daily | **Licensed.** DSE Data Vending Policy cl. 16.3.3 and 23.1 restrict reuse; academic route cl. 17.1, 17.7. We do not scrape it | BLOCKED | Never |
